...
namespace DRPApp2
{
    class MessageAppSettings
    {
        // twitter 
        public static string RequestTokenUri = "https://api.twitter.com/oauth/request_token";
        public static string AuthorizeUri = "https://api.twitter.com/oauth/authorize";
        public static string AccessTokenUri = "https://api.twitter.com/oauth/access_token";
        public static string CallbackUri = "http://www.google.com";   //  Google.com as our callback URL. 

        //#error TODO REGISTER YOUR APP WITH TWITTER TO GET YOUR KEYS AND FILL THEM IN HERE 
        public static string consumerKey = "mC10oTbqBv00OXucdKeNbw";
        public static string consumerKeySecret = "Gbdpb2zUTKQyuR2zx5xrUAPaKvXnWrgiroaJX5a1Is";
    ...
    public class OAuthUtil
    {
        internal static OAuthWebQuery GetRequestTokenQuery()
        {
            ...
            {
                ConsumerKey = MessageAppSettings.consumerKey,
                ConsumerSecret = MessageAppSettings.consumerKeySecret,
                SignatureMethod = OAuthSignatureMethod.HmacSha1,
                ParameterHandling = OAuthParameterHandling.HttpAuthorizationHeader,
                RequestTokenUrl = MessageAppSettings.RequestTokenUri,
                Version = MessageAppSettings.oAuthVersion,
                CallbackUrl = MessageAppSettings.CallbackUri
            };
        ...
        internal static OAuthWebQuery GetAccessTokenQuery(string requestToken, string RequestTokenSecret, string oAuthVerificationPin)
        {
            var oauth = new OAuthWorkflow
            {
                AccessTokenUrl = MessageAppSettings.AccessTokenUri,
                ConsumerKey = MessageAppSettings.consumerKey,
                ConsumerSecret = MessageAppSettings.consumerKeySecret,
                ParameterHandling = OAuthParameterHandling.HttpAuthorizationHeader,
                SignatureMethod = OAuthSignatureMethod.HmacSha1,
