    ...
    public partial class SendMessage : PhoneApplicationPage
    {
        ...
        public SendMessage()
        {
            ...
            { 
                ...
                requestTokenQuery.RequestAsync(MessageAppSettings.RequestTokenUri, null); 
        ...
        { 
            ...
            { 
                ...
                var authorizeUrl = MessageAppSettings.AuthorizeUri + "?oauth_token=" + OAuthTokenKey; 
        ...
        {
            if (e.Uri.ToString().StartsWith(MessageAppSettings.CallbackUri)) 
            { 
                ...
                AccessTokenQuery.RequestAsync(MessageAppSettings.AccessTokenUri, null); 
            } 
        } 
